...
namespace AI_Chat.Plugin.Template
{
    ...
    public class MyPlugin : PluginBase
    {
        ...
        protected override void OnStart()
        {
            ...
            // ═══════════════════════════════════════════════════════════════════════════
            // 拦截器 4：AI 回复拦截器（LLMResponseHandler）
  ...
  所有配置项均可通过前端面板进行修改";
        ...
        public override string GetReadme()
        {
            return @"<div style='padding:15px;font-family:Segoe UI,Microsoft YaHei,sans-serif'>
                ...
                <ul style='line-height:1.8'>
                    <li><b>消息拦截</b> - 注册PreMerge/PostMerge/MessageAppended/LLMResponse拦截器</li>
        ...
        public override PluginPermissionsInfo GetPermissionsInfo()
        {
            ...
            // 声明插件自述的额外权限
            info.DeclaredPermissions.Add("消息拦截 - 注册PreMerge/PostMerge/MessageAppended/LLMResponse拦截器");
